                            ...
                            @forelse($cartItems as $item)
                                <tr>
                                    <td class="product-thumbnail">
                                        <img src="{{ asset('storage/' . $item->product->product_image) }}" alt="Image" class="img-fluid" style="max-width: 80px;">
                                    </td>
                                    <td class="product-name">
                                        <h2 class="h6 text-black">{{ $item->product->product_name }}</h2>
                                    </td>
                                    ...
                                    <td>
                                        <form action="{{ route('cart.update', $item->id) }}" method="POST" class="d-flex">
                                            ...
                                            <div class="input-group mb-3 d-flex align-items-center quantity-container" style="max-width: 140px;">
                                                <input type="number" name="quantity" value="{{ $item->quantity }}" min="1" class="form-control text-center quantity-amount">
